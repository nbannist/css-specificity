	...
	function calculateLineSpecificity(line) {
	    if (line != null && line.trim() != "") {
            ...
            */
            ...
            details += '<div><span class="label">IDs:</span><span class="count">['+breakdown[0][0]+']</span> <span class="list">'+breakdown[1][0].toString().replace(/,/gi,", ")+'</span></div>';
            details += '<div><span class="label">Classes:</span><span class="count">['+breakdown[0][1]+']</span> <span class="list">'+breakdown[1][1].toString().replace(/,/gi,", ")+'</span></div>';
            details += '<div><span class="label">Pseudo Classes:</span><span class="count">['+breakdown[0][2]+']</span> <span class="list">'+breakdown[1][2].toString().replace(/,/gi,", ")+'</span></div>';
            details += '<div><span class="label">Attributes:</span><span class="count">['+breakdown[0][3]+']</span> <span class="list">'+breakdown[1][3].toString().replace(/,/gi,", ")+'</span></div>';
            details += '<div><span class="label">Elements:</span><span class="count">['+breakdown[0][4]+']</span> <span class="list">'+breakdown[1][4].toString().replace(/,/gi,", ")+'</span></div>';
            details += '<div><span class="label">Pseudo Elements:</span><span class="count">['+breakdown[0][5]+']</span> <span class="list">'+breakdown[1][5].toString().replace(/,/gi,", ")+'</span></div>';
            details += '</div>';
